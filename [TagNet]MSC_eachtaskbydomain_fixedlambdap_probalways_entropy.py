...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        train_step(epoch, model, args, optimizer, criterion, domain_criterion, train_loader_zip, phi, init_lambda, tau, inference = False)
        train_step(epoch, model, args, optimizer, criterion, domain_criterion, test_loader_zip, phi, init_lambda, tau, inference = True)
        tau_scheduler.step()
